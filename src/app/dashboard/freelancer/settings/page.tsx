        ...
        <div className="space-y-6" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="glass rounded-3xl border border-white/10 p-6">
                ...
                <form onSubmit={handleUpdateProfile} className="space-y-4 max-w-xl">
                    ...
                    <div>
                        <label className="block text-sm text-white/70 mb-1">{t("نبذة عنك", "Bio / Description")}</label>
                        <textarea
                            name="bio"
                            defaultValue={user?.bio || ""}
                            placeholder={t("اكتب نبذة مختصرة عن مهاراتك وخبراتك...", "Write a short bio about your skills and experience...")}
                            className="w-full bg-black/30 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-white/30 min-h-[100px]"
                        />
                    </div>
